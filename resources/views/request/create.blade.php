                    ...
                    <div class="container px-6 py-8 mx-auto">
                        <div class="max-w-xl mx-auto mt-10">
                            <div class="bg-white shadow-md rounded-lg p-6">
                                <h2 class="text-xl font-semibold text-gray-800 mb-4">Request Edit Data</h2>
                                ...
                                <form action="{{ route('request.store', $mahasiswa->id) }}" method="POST">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="keterangan"
                                            class="block text-gray-600 font-semibold mb-2">Keterangan</label>
                                        <textarea id="keterangan" name="keterangan" rows="4" class="border border-gray-300 rounded-lg w-full p-2"
                                            required></textarea>
                                    </div>
