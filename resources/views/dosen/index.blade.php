        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                ...
                <nav class="mt-10">
                    ...
                    @if (Auth::user()->role == 'dosen_wali' && Auth::user()->dosen && Auth::user()->dosen->kelas_id)
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container px-6 py-8 mx-auto">
                        <h3 class="text-3xl font-medium text-gray-700">Dashboard Dosen</h3>
                        <div class="mt-4">
                            <div class="flex flex-wrap -mx-6">
                                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                        ...
                                        <div class="mx-5">
                                            <h4 class="text-2xl font-semibold text-gray-700">20
                                            </h4>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-lg font-semibold text-gray-600">Daftar Mahasiswa</h4>
                            @if (Auth::user()->role == 'dosen_wali' && Auth::user()->dosen && Auth::user()->dosen->kelas_id)
                                <div class="mt-6">
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody class="bg-white">
                                            @if (Auth::user()->role == 'dosen_wali' && Auth::user()->dosen && Auth::user()->dosen->kelas_id)
                                                ...
                                                @foreach ($mahasiswa->where('kelas_id', Auth::user()->dosen->kelas_id) as $mhs)
                                                    <tr>
                                                        <td
                                                        ...
                                                        <td
                                                            class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            {{ $mhs->user ? $mhs->user->email : 'Tidak Ada Email' }}
                                                        </td>
                                                        <td
                                                            class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            {{ $mhs->name }}</td>
                                                        ...
                                                        <td
                                                            class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            {{ $mhs->tanggal_lahir }}</td>
                                                        <td
                                                            class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            {{ $mhs->kelas->name }}</td>
                                                        <td class="">
                                                            <a href="{{ route('dosen.mahasiswa.edit', $mhs->nim) }}"
                                                            ...
                                                            <form id="delete-form-{{ $mhs->nim }}"
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    onclick="confirmDelete('{{ $mhs->nim }}')">Hapus</button>
                                                            </form>
                                                ...
                                                @foreach ($mahasiswa as $mhs)
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            {{ $mhs->kelas->name }}</td>
                                                        <td class="">
                                                            @if (Auth::user()->role == 'dosen_wali' && Auth::user()->dosen && Auth::user()->dosen->kelas_id == $mhs->kelas_id)
                                                                ...
                                                                <form id="delete-form-{{ $mhs->id }}"
                                                                    ...
                                                                    <button type="button"
                                                                        class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-500"
                                                                        onclick="confirmDelete({{ $mhs->id }})">Hapus</button>
                                                                </form>
                                                            @else
